...
define(['jquery'],function($){
  ...
  var tierThree = function(e){
    ...
    var hasChild = $(this).find('.tier-four').length;
  ...
  if (isMobile === false) {
    ...
    $('.tier-three .left > li').on('mouseenter',tierThree); // end of .tier-three mouseenter

    $('.nav-subnav .dropdown').mouseenter(function(){

      // use bootstrap open methods
      $('.nav-subnav .dropdown').removeClass('open');
      $('.nav-subnav .dropdown > .dropdown-toggle').attr('aria-expanded', false);
      $(this).addClass('open')
    ...
    }); //end of .dropdown mouseenter

    $('.nav-subnav .dropdown').on('mouseleave',function(){
      $(this).delay(700).removeClass('open');
