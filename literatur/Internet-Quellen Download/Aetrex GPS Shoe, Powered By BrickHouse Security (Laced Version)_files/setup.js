function mbcarouselInitCallback_cart1(carousel) 
{
	mybuys.jQuery(".MB_CART1 .MB_CAROUSELLEFT").bind('click', function() { carousel.prev(); return false; });
	mybuys.jQuery(".MB_CART1 .MB_CAROUSELRIGHT").bind('click', function() { carousel.next(); return false; });
	return false;
}
...
function loadjQuery(callback)
{
	...
	{
		var url = 'https://t.p.mybuys.com/clients/BRICKHOUSESECURITY/js/lib/jquery-custom-1.6.4.js';
...
mybuys.initPage = function()
{
	if((this.params["pt"]) && (this.params["pt"].indexOf("purchase") != -1))
	{
		...
		{
			var testemail = Math.max(this.params['email'].toUpperCase().indexOf("FULFILLMENTBYAMAZON@AMAZON.COM"),this.params['email'].toUpperCase().indexOf("@BRICKHOUSESECURITY.COM"));
			if(testemail<0)
			{
				this.base_initPage();
			}
...
var mbJQPageTypes = [ "PRODUCT_DETAILS", "SHOPPING_CART" ];

var mbCarouselZoneKeys = { "PRODUCT_DETAILS": [ { "zoneKey": "1-dep", "visibleItems": 4, "totalItems": 8, "scrollItems": 4, "isVertical": false, "fallbackDimension": 145, "callback": mbcarouselInitCallback_prod1 }, { "zoneKey": "1", "visibleItems": 3, "totalItems": 9, "scrollItems": 3, "isVertical": false, "fallbackDimension": 192, "callback": mbcarouselInitCallback_prod2 } ], "SHOPPING_CART": [ { "zoneKey": "1", "visibleItems": 4, "totalItems": 8, "scrollItems": 4, "isVertical": false, "fallbackDimension": 145, "callback": mbcarouselInitCallback_cart1 } ] };

function mbcarouselInitCallback_prod2(carousel) 
{
	mybuys.jQuery(".MB_PROD2 .MB_CAROUSELLEFT").bind('click', function() { carousel.prev(); return false; });
	mybuys.jQuery(".MB_PROD2 .MB_CAROUSELRIGHT").bind('click', function() { carousel.next(); return false; });
	return false;
}
...
mybuys.setClient("BRICKHOUSESECURITY");
